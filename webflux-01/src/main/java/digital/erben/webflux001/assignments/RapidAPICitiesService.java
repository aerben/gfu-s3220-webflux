...
public class RapidAPICitiesService {
    ...
    /**
     * Retrieves a list of cities that have a specified number of inhabitants or more
     *
     * @param countryCode the country to check for
    ...
    /**
     * Retrieves a list of cities that have a specified number of inhabitants or less
     *
     * @param countryCode the country to check for
     * @param value the comparison value
     * @return the matching cities
